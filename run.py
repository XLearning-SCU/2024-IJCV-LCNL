...
from utils import *
from loss import TripletLoss_WRT, TripletLoss_ADP, RobustTripletLoss_DART, RobustTripletLoss_LCNL
...
parser.add_argument('--loss2', default='robust_tri_lcnl', type=str,
                    metavar='m', help='loss type: wrt or adp or robust_tri_dart or robust_tri_lcnl')
...
parser.add_argument('--op-type', default='weighty', type=str, help='weighty or max or min or max-min or mean')
...
if args.loss2 == 'wrt':
    ...
    criterion_tri.to(device)
elif args.loss2 == 'robust_tri_dart':
    loader_batch = args.batch_size * args.num_pos
    criterion_tri = RobustTripletLoss_DART(batch_size=loader_batch, margin=args.margin)
elif args.loss2 == 'robust_tri_lcnl':
    loader_batch = args.batch_size * args.num_pos
    criterion_tri = RobustTripletLoss_LCNL(batch_size=loader_batch, margin=args.margin, op_type=args.op_type)
